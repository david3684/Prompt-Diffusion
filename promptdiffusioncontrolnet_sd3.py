...
class SD3PromptDiffusionModel(ModelMixin, ConfigMixin, PeftAdapterMixin, FromOriginalModelMixin):
    r"""
    ...
    def __init__(
        ...
        example_pair_cond_embed_input = PatchEmbed(
            height=sample_size,
            width=sample_size,
            patch_size=patch_size,
            in_channels=in_channels + extra_conditioning_channels,
    ...
    def forward(
        ...
        controlnet_example_pair_cond: torch.Tensor,
