...
class SD3PromptDiffusionPipeLine(
    ...
    def __init__(
        ...
        tokenizer_3: T5TokenizerFast,
        controlnet: Union[
            SD3PromptDiffusionModel, List[SD3PromptDiffusionModel], Tuple[SD3PromptDiffusionModel]
        ],
        ...
        if isinstance(controlnet, SD3PromptDiffusionModel):
    ...
    def __call__(
        ...
        control_image_pair: List[PipelineImageInput] = None,
        ...
        controlnet_config = (
            ...
            if isinstance(self.controlnet, SD3PromptDiffusionModel)
        ...
        if isinstance(self.controlnet, SD3PromptDiffusionModel) and control_image_pair is not None:
            # 각 이미지를 개별적으로 준비
            processed_images = [
                self.prepare_image(
                    image=each_image,
        ...
        for i in range(len(timesteps)):
            ...
            controlnet_keep.append(keeps[0] if isinstance(self.controlnet, SD3PromptDiffusionModel) else keeps)
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                control_block_samples = self.controlnet(
                    ...
                    controlnet_example_pair_cond=control_image_pair,
